			...
			<div class="nav-top">
				<nav>
					<ul id="top-menu">
						...
						<li class="active"><a href="teams.php" class="bookmark">Drużyny</a></li>
						<li><a href="players.php" class="bookmark">Zawodnicy</a></li>
					</ul>
				</nav>
			</div>
		</header>
		...
		<div class="content">
			...
			<div class="main-content">
				...
				<div class="content-inside" id="form-teams">
					...
					include('records_teams.php');
					if($result = $mysqli->query('SELECT * FROM teams ORDER BY id DESC')){
						if($result->num_rows > 0){
							while($row = $result->fetch_object()){
								...
								echo "<a class='btn btn-warning col-md-4' href='records_teams.php?id=" . $row->id . "'>Edytuj</a>";
								echo "<a class='btn btn-danger col-md-4' href='delete_teams.php?id=" . $row->id . "'>Usuń</a>";
							}
						}
					}
					createForm();
